...
The purpose is to identify the artifacts changes after account logout.
1. Perform experiments following [Scenario 5](https://github.com/eininondumak/S.TASER/blob/main/Scenarios/5.md#scenarios-5--staser-result---s5-2)
